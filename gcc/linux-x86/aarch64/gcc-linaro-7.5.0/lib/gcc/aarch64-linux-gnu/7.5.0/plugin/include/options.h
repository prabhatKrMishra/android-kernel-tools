...
enum opt_code
{
  ...
  OPT_mcpu_ = 1157,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1158,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1159,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1160,             /* -mgeneral-regs-only */
  OPT_mglibc = 1161,                         /* -mglibc */
  OPT_mlittle_endian = 1162,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1163,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1164,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1165,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1166,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1167,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1168,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1169,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1170,          /* -msign-return-address= */
  OPT_mstrict_align = 1171,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1172,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1173,                     /* -mtls-size= */
  OPT_mtune_ = 1174,                         /* -mtune= */
  OPT_muclibc = 1175,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1176,             /* -mverbose-cost-dump */
  OPT_n = 1177,                              /* -n */
  OPT_no_canonical_prefixes = 1178,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1179,              /* -no-integrated-cpp */
  OPT_no_pie = 1180,                         /* -no-pie */
  ...
  OPT_pie = 1193,                            /* -pie */
  OPT_pipe = 1194,                           /* -pipe */
  OPT_posix = 1195,                          /* -posix */
  OPT_print_file_name_ = 1196,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1197,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1198,          /* -print-multi-directory */
  OPT_print_multi_lib = 1199,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1200,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1201,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1202,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1203,               /* -print-prog-name= */
  OPT_print_search_dirs = 1204,              /* -print-search-dirs */
  OPT_print_sysroot = 1205,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1206,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1207,                        /* -profile */
  OPT_pthread = 1208,                        /* -pthread */
  OPT_quiet = 1209,                          /* -quiet */
  OPT_r = 1210,                              /* -r */
  OPT_rdynamic = 1211,                       /* -rdynamic */
  ...
  OPT_static_libmpx = 1226,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1227,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1228,               /* -static-libstdc++ */
  OPT_static_libtsan = 1229,                 /* -static-libtsan */
  OPT_static_libubsan = 1230,                /* -static-libubsan */
  /* OPT_std_c__03 = 1231, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1232, */                /* -std=c++0x */
  OPT_std_c__11 = 1233,                      /* -std=c++11 */
  OPT_std_c__14 = 1234,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1235, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1236, */                /* -std=c++1y */
  OPT_std_c__1z = 1237,                      /* -std=c++1z */
  OPT_std_c__98 = 1238,                      /* -std=c++98 */
  OPT_std_c11 = 1239,                        /* -std=c11 */
  /* OPT_std_c1x = 1240, */                  /* -std=c1x */
  /* OPT_std_c89 = 1241, */                  /* -std=c89 */
  OPT_std_c90 = 1242,                        /* -std=c90 */
  OPT_std_c99 = 1243,                        /* -std=c99 */
  /* OPT_std_c9x = 1244, */                  /* -std=c9x */
  OPT_std_f2003 = 1245,                      /* -std=f2003 */
  OPT_std_f2008 = 1246,                      /* -std=f2008 */
  OPT_std_f2008ts = 1247,                    /* -std=f2008ts */
  OPT_std_f95 = 1248,                        /* -std=f95 */
  OPT_std_gnu = 1249,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1250, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1251, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1252,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1253,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1254, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1255, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1256,                    /* -std=gnu++1z */
  ...
  OPT_time = 1272,                           /* -time */
  OPT_time_ = 1273,                          /* -time= */
  OPT_traditional = 1274,                    /* -traditional */
  OPT_traditional_cpp = 1275,                /* -traditional-cpp */
  OPT_trigraphs = 1276,                      /* -trigraphs */
  OPT_u = 1277,                              /* -u */
  OPT_undef = 1278,                          /* -undef */
  OPT_v = 1279,                              /* -v */
  OPT_version = 1280,                        /* -version */
  OPT_w = 1281,                              /* -w */
  OPT_wrapper = 1282,                        /* -wrapper */
  OPT_x = 1283,                              /* -x */
  OPT_z = 1284,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
